...
\def\Author{John Doe}              % author name
\def\Degree{doctoral}              % doctoral or masters
\def\Month{Month}                  % month of submission
\def\Year{YEAR}                    % year of submission

\def\Title{\LaTeX\ Dissertation Template for Johns Hopkins University}

%% File paths
\def\FigurePath{figures}           % subdirectory for the figure files
\def\BibFileName{thesis.bib}       % name of the bib file
\def\SecondaryBibFileName{bibtex.bib}       % name for under chapter files
%%%%%%%%%%%%%%%%%%%%%%%%% SETTINGS END HERE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% FRONT MATTER %%%%%%%%%%%%%%%%%%%%%%%%%%%%
% includes title, abstract, [dedication, acknowledgement, epigraph] (optional)
\input{lib/frontmatter}
%%%%%%%%%%%%%%%%%%%%%%%%% END FRONT MATTER %%%%%%%%%%%%%%%%%%%%%%%%%%
...
% You also don't have to nest under the chapters directory, but that's just how
% things are cleaned up here.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% BACK MATTER %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Includes bib endings.
\input{lib/backmatter}
%%%%%%%%%%%%%%%%%%%%%%%%% END BACK MATTER %%%%%%%%%%%%%%%%%%%%%%%%%%%
